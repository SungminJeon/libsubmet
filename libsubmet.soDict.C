...
#define R__DICTIONARY_FILENAME libsubmetdOsoDict
...
namespace {
  void TriggerDictionaryInitialization_libsubmetdOsoDict_Impl() {
...
#line 1 "libsubmetdOsoDict dictionary forward declarations' payload"
...
#line 1 "libsubmetdOsoDict dictionary payload"
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libsubmet.soDict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libsubmetdOsoDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libsubmetdOsoDict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libsubmetdOsoDict() {
  TriggerDictionaryInitialization_libsubmetdOsoDict_Impl();
}
